...
/* package pretty-printer-0.1.0.0 */
#define VERSION_pretty_printer "0.1.0.0"
#define MIN_VERSION_pretty_printer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "pretty-printer-0.1.0.0"

#define CURRENT_PACKAGE_KEY "pretty-printer-0.1.0.0"
